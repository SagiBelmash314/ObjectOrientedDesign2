...
This option will call the "printNames" function on line 389 in the "Main" file.
This function uses the "getArrayNames" function to get the buyer's names in and ArrayLIst,
"getArrayNames" is in the "Manager" class on line 139.

Option 100 (section 16):

To operate this option type 100 in the menu.
This option will call the "printNamesNoDoubles" function on line 398 in the "Main" file.
...
"getLinkedHashmapNames" is in the "Manager" class on line 149.

Option 101 (section 17):

To operate this option type 101 in the menu.
This option will call the "printNameOccurrences" function on line 407 in the "Main" file.
This function uses the "getLinkedHashmapNames" function to get the buyer's names and the number of times they appeared in the original array as key and values accordingly without duplicates,
"getLinkedHashmapNames" is in the "Manager" class on line 149.
...
This option will call the "printNamesNoDoubles" function on line 418 in the "Main" file.
This function uses the "getLinkedHashmapNames" function to get the buyer's names and the number of times they appeared in the original array as key and values accordingly without duplicates,
"getLinkedHashmapNames" is in the "Manager" class on line 149.
...
This option will call the "printNamesSortedByLength" function on line 431 in the "Main" file.
...
"getBuyerTreeSet" is in the "Manager" class on line 163.